...
class OauthAccessToken extends Model
{
     ...
     * @return mixed
     */
    private static function getUserTokens(int $userID, string $guard = 'agent')
    {
     ...
     * @param string $guard
     */
    public static function deleteUserAccessToken(int $userID, string $guard = 'agent')
    {
     ...
     * @param string $guard
     */
    private static function addGuard(string $bearerToken, string $guard = 'agent')
    {
     ...
     * @return array
     */
    public static function createAccessToken(Model $model, string $guard = 'agent'): array
    {
        self::deleteUserAccessToken($model->id, $guard);
        $accessToken = $model->createToken('boonService')->accessToken;
